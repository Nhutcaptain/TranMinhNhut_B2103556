<template>
    <div class="app-header">
        ...
        <div class="app-header-right">
            <div class="search-input">
                ...
                <i class="fa-sharp fa-solid fa-rotate-right refresh-icon" @click="refreshList" data-bs-toggle="tooltip"
                    data-bs-placement="bottom" title="Làm mới"></i>
            </div>
            ...
            <div class="icon">
                ...
                <div class="cart-icon" v-if="!checkAdmin">
                    <i class="fas fa-shopping-cart" @click="openCart" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        title="Giỏ hàng" ref="cartIcon"></i>
                    <div class="count">
                ...
                <div class="add-icon" v-if="checkAdmin" @click="showModel = true" data-bs-toggle="modal"
                    data-bs-target="#myModal">
                    <i class="fa-solid fa-plus" data-bs-toggle="tooltip" data-bs-placement="bottom"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <regisForm :contact="user" @submit:contact="updateUser" v-if="isEdit"></regisForm>
                        </div>
            ...
            <div class="modal fade" id="myModal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <!-- Modal body -->
                        <div class="modal-body">
                            <AddProductForm :products="product" @submit:products="createProduct"></AddProductForm>
                        </div>
    ...
    <div class="app-footer">
        <!-- <div class="footer-info-group">
            <span>Liên hệ với chúng tôi thông qua <a href="https://www.facebook.com/tyty.sat.73"><i class="fa-brands fa-facebook"></i></a></span>
        </div> -->
        <div class="footer-info-group">
            <div class="left-info">
                <h5 style="color: black;">Điều khoản dịch vụ</h5>
                <a href="https://policies.google.com/privacy?hl=vi">Chính sách bảo mật</a>
            </div>
            <div class="right-info">
                <h5>Thông tin liên hệ</h5>
                <div class="info">
                    <span><i class="fa-brands fa-facebook"></i><a href="https://www.facebook.com/tyty.sat.73">:
                            Facebook</a></span> <br>
                    <span><i class="fa-regular fa-envelope"></i>: nhutb2103556@student.ctu.edu.vn</span> <br>
                    <span><i class="fa-solid fa-phone"></i>: 0939129100</span> <br>
                    <span><i class="fa-solid fa-location-dot"></i>: 117/8E, phường Hưng Lợi, Cần Thơ</span> <br>
                </div>
            </div>
        </div>
        <div class="delete-group">
            <div :class="{ 'delete-all': getCheck, 'delete-all-hide': !getCheck }">
                <button class="btn btn-danger" @click="deleteSelectedProducts">Xóa các sản phẩm</button>
            </div>
            <div class="delete-buttom">
                <AppFooter v-model:check="getCheck" :userId="id" v-if="checkAdmin"></AppFooter>
            </div>
        </div>
    </div>
</template>
